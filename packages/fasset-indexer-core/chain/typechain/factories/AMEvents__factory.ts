...
import type { AMEvents, AMEventsInterface } from "../AMEvents";
...
const _bytecode =
  "";

type AMEventsConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: AMEventsConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class AMEvents__factory extends ContractFactory {
  constructor(...args: AMEventsConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): AMEvents__factory {
    return super.connect(runner) as AMEvents__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AMEventsInterface {
    return new Interface(_abi) as AMEventsInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): AMEvents {
    return new Contract(address, _abi, runner) as unknown as AMEvents;
  }
}
